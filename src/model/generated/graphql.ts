...
export type DocumentsQuery = { __typename?: 'Query', documents: { __typename?: 'DocumentCursor', cursor?: unknown | null, totalAvailable: number, results: Array<{ __typename: 'OralExam', id: string, date: string, semester: string, public: boolean, publicComment?: string | null, internalComment?: string | null, publishedOn?: string | null, downloadable: boolean, rating: Rating, numPages?: number | null, examiners: Array<{ __typename?: 'Examiner', id: string, name: string, displayName: string }>, lectures: Array<{ __typename?: 'Lecture', id: string, displayName: string }> } | { __typename: 'WrittenExam', solution: SolutionType, id: string, date: string, semester: string, public: boolean, publicComment?: string | null, internalComment?: string | null, publishedOn?: string | null, downloadable: boolean, rating: Rating, numPages?: number | null, examiners: Array<{ __typename?: 'Examiner', id: string, name: string, displayName: string }>, lectures: Array<{ __typename?: 'Lecture', id: string, displayName: string }> }> } };
