...
export type PriceSummaryQueryVariables = Exact<{
  documents: Array<Scalars['DocumentId']> | Scalars['DocumentId'];
  numOralDeposits: Scalars['Int'];
}>;


export type PriceSummaryQuery = { __typename?: 'Query', price?: number | null };
...
export const PriceSummaryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"priceSummary"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"documents"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DocumentId"}}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"numOralDeposits"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"price"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"documents"},"value":{"kind":"Variable","name":{"kind":"Name","value":"documents"}}},{"kind":"Argument","name":{"kind":"Name","value":"numOralExamDeposits"},"value":{"kind":"Variable","name":{"kind":"Name","value":"numOralDeposits"}}}]}]}}]} as unknown as DocumentNode<PriceSummaryQuery, PriceSummaryQueryVariables>;
